...
Document-specific settings and content. The main configuration will be merged with this for each document.
...
Page-specific settings and content. The (already merged) document configuration will be merged with this for access to all settings in your template.
...
text_1: |-
  Kiwi PyCon has been Python New
...
2. The three levels (main, document, page) are just for organisation (Don't Repeat Yourself)
...
Create multiple versions of a document by defining variants in the document configuration:
